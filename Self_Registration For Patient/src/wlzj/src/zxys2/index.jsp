					...
					<div class="vddlicon">
						<span class="vddliconli">
							<span id="deptName">血液病科专家门诊</span>
							 <span id="doctorName">韦菊英</span>							
							 <span id="time" style="margin-left: 10px;">
							 	时间：2018-05-11 早上 出诊时间：10:30
							 </span>														
							 <div class="deptinsbut">
							 	专家介绍								
							 	<div class="deptinsjiao"></div>
								<div class="deptinsdet" style="left: -350px;">
			...
			<div class="ihsickhis">
				...
				<div id="historyDetail" style="margin: 0 35px;">
					...
					<div class="uploadsome">
						<span>其它</span><input id="others1" type="text" class="uploadother" placeholder="补充说明" name="moreinfo">
		...
		<div id="chooseHistory3" class="inthospopup" style="display: none;">
			...
			<div class="ihsickhis">
				...
				<div id="historyDetail" style="margin: 0 35px;">
					...
					<div class="uploadsome">
						<span>其它</span><input id="others3" type="text" class="uploadother" placeholder="补充说明">
